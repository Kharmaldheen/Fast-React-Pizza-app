...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    small: base + ' py-2 md:px-5 md:py-2.5 px-3 text-xs',
    secondary:
      'inline-block text-sm rounded-full border-2 border-stone-300  font-semibold uppercase -tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:outline-none focus:ring focus:ring-stone-300 focus:text-stone-800 focus:ring-offset-2 disabled:cursor-not-allowed md:px-6 md:py-3.5 px-4 py-2.5',
